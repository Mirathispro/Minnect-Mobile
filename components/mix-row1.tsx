...
export type MixRow1Type = {
  className?: string;
};

const MixRow1: NextPage<MixRow1Type> = ({ className = "" }) => {
  return (
    <div
    ...
    >
      <div className="self-stretch flex flex-col items-start justify-start gap-[0.8px]">
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-[15px]">
          <div className="h-[2.5px] flex-1 relative rounded-t-[6.02px] rounded-b-none bg-lightblue-200" />
        </div>
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[7px] pl-1.5">
          <div className="h-[5px] flex-1 relative rounded-t-[6.02px] rounded-b-none bg-lightblue-300" />
        </div>
        <div className="rounded-[6.02px] overflow-hidden flex flex-row items-start justify-start pt-[0.3px] px-0 pb-0 relative bg-[url('/image-3@2x.png')] bg-cover bg-no-repeat bg-[top]">
          ...
          <img
            className="h-[141.1px] w-[141.1px] relative object-cover z-[6]"
            alt=""
            src="/image-11@2x.png"
          />
        </div>
      ...
      <div className="self-stretch h-4 flex flex-row items-start justify-start gap-[25.5px]">
        ...
        <div className="self-stretch w-4 relative tracking-[0.03em] text-lightblue-100 inline-block shrink-0">
          50
        </div>
      </div>
      <div className="self-stretch h-[26px] relative text-3xs tracking-[0.03em] text-fg-secondary inline-block">
        Frank Sinatra, Gerhard Trede, Dean Martin and more
      </div>
    </div>
  );
};

export default MixRow1;
